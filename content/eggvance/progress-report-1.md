...
{{<figures>}}
  {{<figure src="pokemon-emerald.png" caption="Figure 1 - Pokemon Emerald">}}
  {{<figure src="yoshis-island.png" caption="Figure 2 - Yoshi's Island">}}
{{</figures>}}
...
{{<figures>}}
  {{<figure src="tonc-sbb-aff.png" caption="Figure 3 - Affine tiled background">}}
  {{<figure src="tonc-obj-aff.png" caption="Figure 4 - Affine sprite">}}
{{</figures>}}
