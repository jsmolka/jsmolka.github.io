...
{{<figures>}}
  {{<figure src="thumb-format.png" caption="Figure 1 - Thumb format">}}
{{</figures>}}
...
{{<figures>}}
  {{<figure src="sonic-rcnt.png" caption="Figure 2 - Uninitialized RCNT">}}
  {{<figure src="sonic.png" caption="Figure 3 - Initalized RCNT">}}
{{</figures>}}
...
{{<figures>}}
  {{<figure src="carry-tests-fail.png" caption="Figure 4 - Carry tests fail">}}
  {{<figure src="carry-tests-pass.png" caption="Figure 5 - Carry tests pass">}}
{{</figures>}}
...
{{<figures>}}
  {{<figure src="doom-bug-1.png" caption="Figure 6 - DOOM II bug">}}
  {{<figure src="doom-bug-2.png" caption="Figure 7 - DOOM II bug">}}
{{</figures>}}
